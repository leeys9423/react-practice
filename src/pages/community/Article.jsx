...
const NoticeBoard = () => {
  const notices = [
    { id: 1, title: '"헌혈하니 식빵에 계란프라이가"…47년간 152회 \'헌혈유공자\'', date: '2024-03-15', views: 156 },
    { id: 2, title: '적십자사, 멕시카나치킨과 헌혈문화 확산을 위한 업무협약 체결', date: '2024-03-10', views: 234 },
    { id: 3, title: '“헌혈은 생명 살리는 고귀한 선행”, 대구경북혈액원 김기헌 팀장', date: '2024-03-05', views: 189 },
    { id: 4, title: '누네안과병원, 12년째 헌혈나눔 캠페인 \'90일의 기적\' 진행', date: '2024-03-01', views: 145 },
    { id: 5, title: '이런 뉴스만 있다면…올겨울도 훈훈', date: '2024-02-28', views: 167 },
  ];
